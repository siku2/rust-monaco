pub mod monaco {
    ...
    extern "C" {
        ...
        /// The base url where the editor sources are found (which contains the
        /// vs folder)
    ...
    extern "C" {
        ...
        /// Listeners that are registered after cancellation will be
        /// called (next event loop run), but also only once.
        ///
        /// @event
        #[wasm_bindgen(
            method,
    ...
    extern "C" {
        ...
        /// Returns a string representing the corresponding file system path of
        /// this Uri. Will handle UNC paths, normalizes windows drive
        /// letters to lower-case, and uses the platform specific path
        /// separator.
        ///
        ...
        /// separator and the handling of UNC paths. See the below
        /// sample of a file-uri with an authority (UNC path).
        ///
        /// ```ts
        ...
        /// because parts of the path, namely the server name, would be
        /// missing. Therefore `Uri#fsPath` exists - it's sugar to ease working
        ...
        ///
        /// The *difference* between `Uri#parse` and `Uri#file` is that the
        /// latter treats the argument as path, not as stringified-uri.
        /// E.g. `Uri.file(path)` is **not the same as** `Uri.parse('file://' + path)` because the path might contain characters that are
        ...
        /// function performs validation and should be used for
        /// untrusted uri components retrieved from storage, user input,
        /// command arguments etc

        #[wasm_bindgen(js_class = "{type}", js_name = "{name}", static_method_of = Uri)]
        pub fn from(components: UriComponents, strict: Option<bool>) -> Uri;

        /// Join a Uri path with path fragments and normalizes the resulting
        /// path.
        ///
        ...
        /// calling `Uri.parse` with the result of this function creates
        /// an Uri which is equal to this Uri.
        ///
        /// * The result shall *not* be used for display purposes but for
        ///   externalization or transport.
        /// * The result will be encoded using the percentage encoding and
        ///   encoding happens mostly
        ...
        ///
        /// **Note** that this function should only be used when receiving
        /// Uri#toJSON generated data and that it doesn't do any
        /// validation. Use {@link Uri.from} when received "untrusted"
    ...
    extern "C" {
        ...
        /// column (the first character in a line is between column 1 and column
        /// 2)
    ...
    extern "C" {
        ...
        /// Column on which the range starts in line `startLineNumber` (starts
        /// at 1).
    ...
    extern "C" {
        ...
        /// Test if position is in this range. If the position is at the edges,
        /// will return true.

        #[wasm_bindgen(js_class = "{type}", js_name = "{name}", method)]
        pub fn contains_position(this: &Range, position: IPosition) -> bool;

        /// Test if `position` is in `range`. If the position is at the edges,
        /// will return true.
        ...
        /// Test if `otherRange` is in `range`. If the ranges are equal, will
        /// return true.
        ...
        /// Test if `otherRange` is strictly in `range` (must start after, and
        /// end before). If the ranges are equal, will return false.

        #[wasm_bindgen(js_class = "{type}", js_name = "{name}", static_method_of = Range)]
        pub fn strict_contains_range_1(range: IRange, other_range: IRange) -> bool;

        /// A reunion of the two ranges.
        /// The smallest position will be used as the start point, and the
        ...
        /// Test if the two ranges are intersecting. If the ranges are touching
        /// it returns true.
    ...
    pub mod editor {
        ...
        extern "C" {
            ...
            /// Callback that is invoked when a resource other than the current
            /// model should be opened (e.g. when "go to definition" is called).
            /// The callback should return `true` if the request was handled and
            /// `false` otherwise. @param source The code editor
            /// instance that initiated the request. @param resource
            /// The Uri of the resource that should be opened.
            /// @param selectionOrPosition An optional position or selection
            /// inside the model corresponding to `resource` that can be used to
            /// set the cursor.
            ...
            pub fn open_code_editor(
                ...
                source: ICodeEditor,
                resource: Uri,
                selection_or_position: Option<JsValue>,
            ) -> JsValue;
        ...
        extern "C" {
            ...
            /// It should export a function `create` that should return the
            /// exported proxy.
            ...
            /// A label to be used to identify the web worker for debugging
            /// purposes.
            ...
            /// An object that can be used by the web worker to make calls back
            /// to the main thread.
            ...
            /// Keep idle models.
            /// Defaults to false, which means that idle models will stop
            /// syncing after a while.
            #[wasm_bindgen(
                method,
        ...
        extern "C" {
            ...
            /// Control if the action should show up in the context menu and
            /// where. The context menu of the editor has these
            /// default:   navigation - The navigation group comes
            /// first in all cases.   1_modification - This group
            /// comes next and contains commands that modify your code.
            ///   9_cutcopypaste - The last default group with the basic editing
            /// commands. You can also create your own group.
        ...
        extern "C" {
            ...
            /// Controls whether `tabSize` and `insertSpaces` will be
            /// automatically detected when a file is opened based on the file
            ...
            /// Special handling for large files to disable certain memory
            /// intensive features. Defaults to true.
            #[wasm_bindgen(
                method,
                js_class = "IGlobalEditorOptions",
            ...
            /// Controls whether completions should be computed based on words
            /// in the document. Defaults to true.
            #[wasm_bindgen(
                method,
                js_class = "IGlobalEditorOptions",
            ...
            /// Controls whether word based completions should be included from
            ...
            /// Keep peek editors open even when double-clicking their content
            /// or when hitting `Escape`. Defaults to false.
            #[wasm_bindgen(
                method,
                js_class = "IGlobalEditorOptions",
                js_name = "stablePeek",
            ...
            /// 'vs-dark', 'hc-black', 'hc-light'. You can create
            /// custom themes via `monaco.editor.defineTheme`.
            /// To switch a theme, use `monaco.editor.setTheme`.
            /// **NOTE**: The theme might be overwritten if the OS is in high
            /// contrast mode, unless `autoDetectHighContrast` is set to false.
            ...
            /// If enabled, will automatically change to high contrast theme if
            /// the OS is using a high contrast theme. Defaults to
            /// true.
            #[wasm_bindgen(
                method,
                js_class = "IGlobalEditorOptions",
        ...
        extern "C" {
            ...
            /// An URL to open when Ctrl+H (Windows and Linux) or Cmd+H (OSX) is
            /// pressed in the accessibility help dialog in the
            /// editor.
            ///
        ...
        extern "C" {
            ...
            pub fn set(this: &IContextKey, value: T);
        ...
        extern "C" {
            ...
            /// The range to replace. This can be empty to emulate a simple
            /// insert.
            ...
            /// The text to replace with. This can be null to emulate a simple
            /// delete.
            ...
            /// i.e. forceMoveMarkers = true => if `range` is collapsed, all
            /// markers at the position will be moved.
            #[wasm_bindgen(
                method,
        ...
        extern "C" {
            ...
            /// CSS color to render.
            /// e.g.: rgba(100, 100, 100, 0.5) or a color from the color
            /// registry
        ...
        extern "C" {
            ...
            /// Customize the growing behavior of the decoration when typing at
            /// the edges of the decoration. Defaults to
            ...
            /// Indicates whether the decoration should span across the entire
            /// line when it continues onto the next line.
            #[wasm_bindgen(
                method,
                js_class = "IModelDecorationOptions",
            ...
            /// Message to be rendered when hovering over the glyph margin
            /// decoration.
            #[wasm_bindgen(
                method,
                js_class = "IModelDecorationOptions",
            ...
            /// Always render the decoration (even when the range it encompasses
            /// is collapsed).
            #[wasm_bindgen(
                method,
                js_class = "IModelDecorationOptions",
            ...
            /// A decoration with greater stack order is always in front of a
            /// decoration with a lower stack order when the
            /// decorations are on the same line.
            #[wasm_bindgen(
                method,
                js_class = "IModelDecorationOptions",
                js_name = "zIndex",
            ...
            /// If set, the decoration will be rendered in the glyph margin with
            /// this CSS class name.
            #[wasm_bindgen(
                method,
                js_class = "IModelDecorationOptions",
            ...
            /// If set and the decoration has {@link glyphMarginClassName} set,
            /// render this decoration with the specified {@link
            /// IModelDecorationGlyphMarginOptions} in the glyph margin.
            #[wasm_bindgen(
                method,
                js_class = "IModelDecorationOptions",
                js_name = "glyphMargin",
            ...
            /// If set, the decoration will be rendered in the lines decorations
            ...
            /// If set, the decoration will be rendered in the lines decorations
            /// with this CSS class name, but only for the first line in case of
            /// line wrapping.
            #[wasm_bindgen(
                method,
                js_class = "IModelDecorationOptions",
            ...
            /// If set, the decoration will be rendered in the margin (covering
            /// its full width) with this CSS class name.
            #[wasm_bindgen(
                method,
                js_class = "IModelDecorationOptions",
            ...
            /// with this CSS class name. Please use this only for
            /// CSS rules that must impact the text. For example, use
            /// `className` to have a background color decoration.
            #[wasm_bindgen(
                method,
                js_class = "IModelDecorationOptions",
            ...
            /// If set, the decoration will be rendered before the text with
            /// this CSS class name.
            #[wasm_bindgen(
                method,
                js_class = "IModelDecorationOptions",
            ...
            /// If set, the decoration will be rendered after the text with this
            /// CSS class name.
            #[wasm_bindgen(
                method,
                js_class = "IModelDecorationOptions",
        ...
        extern "C" {
            ...
            /// The data can be read when injected texts at a given position are
            /// queried.
            #[wasm_bindgen(
                method,
                js_class = "InjectedTextOptions",
        ...
        extern "C" {
            ...
            /// The text to replace with. This can be empty to emulate a simple
            /// delete.
        ...
        extern "C" {
            ...
            /// @param preserverBOM Preserve a BOM character if it was detected
            /// when the model was constructed. @return The text.
            ...
            /// @param preserverBOM Preserve a BOM character if it was detected
            /// when the model was constructed. @return The text
            /// snapshot (it is safe to consume it asynchronously).
            ...
            /// @param eol The end of line character preference. This will only
            /// be used for multiline ranges. Defaults to
            /// `EndOfLinePreference.TextDefined`. @return The text.
            ...
            /// Returns the column before the first non whitespace character for
            /// line at `lineNumber`. Returns 0 if line is empty or
            ...
            /// Returns the column after the last non whitespace character for
            /// line at `lineNumber`. Returns 0 if line is empty or
            /// contains only whitespace.
            #[wasm_bindgen(
                method,
            ...
            /// Advances the given position by the given offset (negative
            /// offsets are also accepted) and returns it as a new
            /// valid position.
            ///
            /// If the offset and position are such that their combination goes
            /// beyond the beginning or end of the model, throws an
            /// exception.
            ///
            /// If the offset is such that the new position would be in the
            /// middle of a multi-byte line terminator, throws an
            /// exception.
            ...
            /// Search the model.
            /// @param searchString The string used to search. If it is a
            /// regular expression, set `isRegex` to true.
            /// @param searchOnlyEditableRange Limit the searching to only
            /// search inside the editable range of the model.
            /// @param isRegex Used to indicate that `searchString` is a regular
            /// expression. @param matchCase Force the matching to
            /// match lower/upper case exactly.
            /// @param wordSeparators Force the matching to match entire words
            /// only. Pass null otherwise. @param captureMatches The
            /// result will contain the captured groups.
            /// @param limitResultCount Limit the number of results
            /// @return The ranges where the matches are. It is empty if not
            ...
            /// @param searchString The string used to search. If it is a
            /// regular expression, set `isRegex` to true.
            /// @param searchScope Limit the searching to only search inside
            /// these ranges. @param isRegex Used to indicate that
            /// `searchString` is a regular expression.
            /// @param matchCase Force the matching to match lower/upper case
            /// exactly. @param wordSeparators Force the matching to
            /// match entire words only. Pass null otherwise. @param
            /// captureMatches The result will contain the captured groups.
            /// @param limitResultCount Limit the number of results
            /// @return The ranges where the matches are. It is empty if no
            /// matches have been found.
            #[wasm_bindgen(method, js_class = "ITextModel", js_name = "findMatches")]
            ...
            /// Search the model for the next match. Loops to the beginning of
            /// the model if needed. @param searchString The string
            /// used to search. If it is a regular expression, set `isRegex` to
            /// true. @param searchStart Start the searching at the
            /// specified position. @param isRegex Used to indicate
            /// that `searchString` is a regular expression.
            /// @param matchCase Force the matching to match lower/upper case
            /// exactly. @param wordSeparators Force the matching to
            /// match entire words only. Pass null otherwise. @param
            /// captureMatches The result will contain the captured groups.
            /// @return The range where the next match is. It is null if no next
            ...
            /// Search the model for the previous match. Loops to the end of the
            /// model if needed. @param searchString The string used
            /// to search. If it is a regular expression, set `isRegex` to true.
            /// @param searchStart Start the searching at the specified
            /// position. @param isRegex Used to indicate that
            /// `searchString` is a regular expression.
            /// @param matchCase Force the matching to match lower/upper case
            /// exactly. @param wordSeparators Force the matching to
            /// match entire words only. Pass null otherwise. @param
            /// captureMatches The result will contain the captured groups.
            /// @return The range where the previous match is. It is null if no
            /// previous match has been found.
            ...
            /// Get the word under or besides `position` trimmed to
            /// `position`.column @param position The position to
            /// look for a word. @return The word under or besides
            /// `position`. Will never be null.
            ...
            /// Perform a minimum amount of operations, in order to transform
            /// the decorations identified by `oldDecorations` to
            /// the decorations described by `newDecorations`
            /// and returns the new identifiers associated with the resulting
            /// decorations.
            ///
            /// @param oldDecorations Array containing previous decorations
            /// identifiers. @param newDecorations Array describing
            /// what decorations should result after the call.
            /// @param ownerId Identifies the editor id in which these
            /// decorations should appear. If no `ownerId` is provided, the
            ...
            /// @return The decoration options or null if the decoration was not
            /// found.
            ...
            /// @param id The decoration id.
            /// @return The decoration range or null if the decoration was not
            /// found.
            ...
            /// @param ownerId If set, it will ignore decorations belonging to
            /// other owners. @param filterOutValidation If set, it
            /// will ignore decorations specific to validation (i.e. warnings,
            /// errors). @return An array with the decorations
            ...
            /// `startLineNumber` and `endLineNumber` from `range` are used for
            /// filtering. So for now it returns all the decorations
            /// on the same line as `range`. @param range The range
            /// to search in @param ownerId If set, it will ignore
            /// decorations belonging to other owners.
            /// @param filterOutValidation If set, it will ignore decorations
            /// specific to validation (i.e. warnings, errors).
            /// @param onlyMinimapDecorations If set, it will return only
            /// decorations that render in the minimap.
            /// @param onlyMarginDecorations If set, it will return only
            /// decorations that render in the glyph margin. @return
            ...
            /// Gets all decorations that render in the glyph margin as an
            /// array. @param ownerId If set, it will ignore
            /// decorations belonging to other owners.
            ...
            /// Gets all the decorations that should be rendered in the overview
            /// ruler as an array. @param ownerId If set, it will
            /// ignore decorations belonging to other owners. @param
            /// filterOutValidation If set, it will ignore decorations specific
            /// to validation (i.e. warnings, errors).
            #[wasm_bindgen(
                method,
                js_class = "ITextModel",
            ...
            /// Normalize a string containing whitespace according to
            /// indentation rules (converts to spaces or to tabs).
            ...
            /// Push edit operations, basically editing the model. This is the
            /// preferred way of editing the model. The edit
            /// operations will land on the undo stack.
            /// @param beforeCursorState The cursor state before the edit
            /// operations. This cursor state will be returned when `undo` or
            /// `redo` are invoked. @param editOperations The edit
            /// operations. @param cursorStateComputer A callback
            /// that can compute the resulting cursors state after the edit
            /// operations have been executed. @return The cursor
            /// state returned by the `cursorStateComputer`.
            ...
            /// @pushEditOperations for the preferred way.
            /// @param operations The edit operations.
            /// @return If desired, the inverse edit operations, that, when
            ...
            /// Change the end of line sequence without recording in the undo
            /// stack. This can have dire consequences on the undo
            /// stack! See @pushEOL for the preferred way.
            ...
            /// An event emitted when the language configuration associated with
            /// the model has changed. @event
            #[wasm_bindgen(
                method,
                js_class = "ITextModel",
            ...
            /// An event emitted when the model has been attached to the first
            /// editor or detached from the last editor. @event
            #[wasm_bindgen(
                method,
                js_class = "ITextModel",
        ...
        extern "C" {
            ...
            /// Computes the diff between the text models `original` and
            /// `modified`.
            ...
            /// Is fired when settings of the diff algorithm change that could
            /// alter the result of the diffing computation.
            /// Any user of this provider should recompute the diff when this
            /// event is fired.
            #[wasm_bindgen(
                method,
        ...
        extern "C" {
            ...
            /// A diff computation should throw if it takes longer than this
            /// value.
            #[wasm_bindgen(
                method,
                js_class = "IDocumentDiffProviderOptions",
            ...
            /// If set, the diff computation should compute moves in addition to
        ...
        extern "C" {
            ...
            /// If true, the diff computation timed out and the diff might not
            /// be accurate.
            #[wasm_bindgen(method, js_class = "IDocumentDiff", js_name = "quitEarly", getter)]
            pub fn quit_early(this: &IDocumentDiff) -> bool;
            /// Maps all modified line ranges in the original to the
            /// corresponding line ranges in the modified text model.
            #[wasm_bindgen(method, js_class = "IDocumentDiff", js_name = "changes", getter)]
            pub fn changes(this: &IDocumentDiff) -> JsValue;
            /// Sorted by original line ranges.
            /// The original line ranges and the modified line ranges must be
            /// disjoint (but can be touching).
        ...
        extern "C" {
            ...
            /// Creates a line range that combines this and the given line
            /// range.
            ...
            /// The resulting range is empty if the ranges do not intersect, but
            /// touch. If the ranges don't even touch, the result is
            /// undefined.
        ...
        extern "C" {
            ...
            /// @param range The range to replace (delete). May be empty to
            /// represent a simple insert. @param text The text to
            /// replace with. May be null to represent a simple delete.
            #[wasm_bindgen(
                method,
            ...
            /// indicates whether the selection           should
            /// clamp to the previous or the next character. @return
            /// A unique identifier.
        ...
        extern "C" {
            ...
            /// @param builder A helper to collect the needed edit operations
            /// and to track selections.
            ...
            /// previously tracked selections. @return The cursor
            /// state after the command executed.
        ...
        extern "C" {
            ...
            pub fn run(this: &IEditorAction, args: Option<JsValue>) -> Promise;
        ...
        extern "C" {
            ...
            /// Instructs the editor to remeasure its container. This method
            /// should be called when the container of the editor
            /// gets resized.
            ///
            ...
            /// Returns true if the text inside this editor is focused (i.e.
            /// cursor is blinking).
            ...
            /// Given a position, returns a column number that takes tab-widths
            /// into account.
            ...
            /// Set the primary position of the cursor. This will remove any
            /// secondary cursors. @param position New primary
            /// cursor's position @param source Source of the call
            /// that caused the position
            ...
            /// Scroll vertically as necessary and reveal a line centered
            /// vertically.
            ...
            /// Scroll vertically as necessary and reveal a line close to the
            /// top of the viewport, optimized for viewing a code
            /// definition.
            ...
            /// Scroll vertically or horizontally as necessary and reveal a
            /// position.
            ...
            /// Scroll vertically or horizontally as necessary and reveal a
            /// position centered vertically only if it lies outside the
            /// viewport.
            #[wasm_bindgen(
                method,
                js_class = "IEditor",
            ...
            /// Scroll vertically or horizontally as necessary and reveal a
            /// position close to the top of the viewport, optimized
            ...
            /// Set the primary selection of the editor. This will remove any
            /// secondary cursors. @param selection The new
            /// selection @param source Source of the call that
            ...
            /// Scroll vertically as necessary and reveal lines centered
            /// vertically.
            ...
            /// Scroll vertically as necessary and reveal lines close to the top
            /// of the viewport, optimized for viewing a code
            /// definition.
            ...
            /// Scroll vertically or horizontally as necessary and reveal a
            /// range at the top of the viewport.
            ...
            /// Scroll vertically or horizontally as necessary and reveal a
            /// range centered vertically only if it lies outside the viewport.
            #[wasm_bindgen(
                method,
                js_class = "IEditor",
            ...
            /// Scroll vertically or horizontally as necessary and reveal a
            /// range close to the top of the viewport,
            ...
            /// Scroll vertically or horizontally as necessary and reveal a
            /// range close to the top of the viewport,
            /// optimized for viewing a code definition. Only if it lies outside
            /// the viewport.
            #[wasm_bindgen(
                method,
                js_class = "IEditor",
            ...
            /// @param handlerId The id of the handler or the id of a
            /// contribution. @param payload Extra data to be sent
            /// to the handler.
            ...
            /// key in the options literal object, it will be
            /// destroyed. Otherwise, if the previous model was set
            /// via setModel, or the model key in the options literal object,
            /// the previous model will not be destroyed.
            /// It is safe to call setModel(null) to simply detach the current
            /// model from the editor.
            #[wasm_bindgen(method, js_class = "IEditor", js_name = "setModel")]
            pub fn set_model(this: &IEditor, model: JsValue);

            /// Create a collection of decorations. All decorations added
            /// through this collection will get the ownerId of the
            /// editor (meaning they will not show up in other editors).
            /// These decorations will be automatically cleared when the
        ...
        extern "C" {
            ...
            /// but the change is not caused by us setting or clearing the
            /// collection.
            #[wasm_bindgen(
                method,
        ...
        extern "C" {
            ...
            /// Flag that indicates that all decorations were lost with this
            /// edit. The model has been reset to a new value.
            #[wasm_bindgen(
                method,
                js_class = "IModelContentChangedEvent",
                js_name = "isFlush",
        ...
        extern "C" {
            ...
            /// Whether the aria-required attribute should be set on the editors
            /// textarea.
            ...
            /// Control whether a screen reader announces inline suggestion
            /// content immediately.
            #[wasm_bindgen(
                method,
            ...
            /// A string containing the word separators used when doing word
            ...
            /// If it is a function, it will be invoked when rendering a line
            /// number and the return value will be rendered.
            /// Otherwise, if it is a truthy, line numbers will be rendered
            /// normally (equivalent of using an identity function).
            ...
            /// Controls the minimal number of visible leading and trailing
            /// lines surrounding the cursor. Defaults to 0.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Defaults to `default`, `cursorSurroundingLines` is not enforced
            /// when cursor position is changed by mouse.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Remove unusual line terminators like LINE SEPARATOR (LS),
            /// PARAGRAPH SEPARATOR (PS). Defaults to 'prompt'.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Should the corresponding line be selected when clicking on the
            /// line number? Defaults to true.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// for rendering at least an amount of digits. Defaults
            /// to 5.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Line decorations are placed between line numbers and the editor
            /// content. You can pass in a string in the format
            /// floating point followed by "ch". e.g. 1.3ch.
            /// Defaults to 10.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// When revealing the cursor, a virtual padding (px) is added to
            /// the cursor, turning it into a rectangle.
            /// This virtual padding ensures that the cursor gets revealed
            /// before hitting the edge of the viewport. Defaults to
            /// 30 (px).
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Should the textarea used for input use the DOM `readonly`
            ...
            /// 'smooth', 'phase', 'expand' and 'solid'. Defaults to
            /// 'blink'.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// combination with holding Ctrl. Defaults to false.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Control the mouse pointer style, either 'text' or 'default' or
            ...
            /// Controls whether to use default color decorations or not using
            /// the default document color provider
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Disable the use of `transform: translate3d(0px, 0px, 0px)` for
            /// the editor margin and lines layers. The usage of
            /// `transform: translate3d(0px, 0px, 0px)` acts as a hint for
            /// browsers to create an extra layer. Defaults to
            /// false.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Enable that scrolling can go one screen size after the last
            ...
            /// Enable that scrolling can go beyond the last column by a number
            /// of columns. Defaults to 5.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Enable that the editor will install a ResizeObserver to check if
            /// its container dom node size has changed. Defaults to
            /// false.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// When `wordWrap` = "on", the lines will wrap at the viewport
            /// width. When `wordWrap` = "wordWrapColumn", the lines
            /// will wrap at `wordWrapColumn`. When `wordWrap` =
            /// "bounded", the lines will wrap at min(viewport width,
            /// wordWrapColumn). Defaults to "off".
            ...
            /// Control indentation of wrapped lines. Can be: 'none', 'same',
            /// 'indent' or 'deepIndent'. Defaults to 'same' in
            /// vscode and to 'none' in monaco-editor.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Configure word wrapping characters. A break will be introduced
            ...
            /// otherwise overflow its content box. When wordBreak =
            /// 'normal', Use the default line break rule.
            /// When wordBreak = 'keepAll', Word breaks should not be used for
            /// Chinese/Japanese/Korean (CJK) text. Non-CJK text behavior is the
            /// same as for normal.
            ...
            /// Controls what is the condition to spawn a color picker from a
            /// color dectorator
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Controls the max number of color decorators that can be rendered
            /// in an editor at once.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// A multiplier to be used on the `deltaX` and `deltaY` of mouse
            /// wheel scroll events. Defaults to 1.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Enable that the editor scrolls only the predominant axis.
            /// Prevents horizontal drift when scrolling vertically on a
            /// trackpad. Defaults to true.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Enable that the selection with the mouse and keys is doing
            /// column selection. Defaults to false.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Configure the behaviour when pasting a text with the line count
            /// equal to the cursor count. Defaults to 'spread'.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Controls the max number of text cursors that can be in an active
            /// editor at once.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Controls the number of lines in the editor that can be read out
            /// by a screen reader
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Emulate selection behaviour of tab characters when using spaces
            /// for indentation. This means selection will stick to
            /// tab stops.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Controls if the editor should allow to move selections via drag
            /// and drop. Defaults to false.
            ...
            /// Selects the folding strategy. 'auto' uses the strategies
            /// contributed for the current document, 'indentation' uses the
            /// indentation based folding strategy. Defaults to
            /// 'auto'.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Controls whether the fold actions in the gutter stay always
            /// visible or hide unless the mouse is over the gutter.
            ...
            /// Controls whether clicking on the empty content after a folded
            /// line will unfold the line. Defaults to false.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Control if the current line highlight should be rendered only
            /// the editor is focused. Defaults to false.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Controls whether to focus the inline editor in the peek widget
            ...
            /// Controls whether the definition link opens element in the peek
            ...
            /// Controls whether suggestions allow matches in the middle of the
            /// word instead of only at the beginning
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// (by default, ambiguous and invisible characters are
            /// highlighted).
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            ///
            /// When enabled, this shows a preview of the drop location and
            /// triggers an `onDropIntoEditor` event.
            #[wasm_bindgen(
                method,
                js_class = "IEditorOptions",
            ...
            /// Controls support for changing how content is pasted into the
            /// editor.
        ...
        extern "C" {
            ...
            /// Timeout in milliseconds after which diff computation is
            /// cancelled. Defaults to 5000.
            #[wasm_bindgen(
                method,
                js_class = "IDiffEditorBaseOptions",
        ...
        extern "C" {
            ...
            pub fn get(this: &IComputedEditorOptions, id: T) -> FindComputedEditorOptionValueById;
        ...
        extern "C" {
            ...
            pub fn id(this: &IEditorOption) -> K;
            ...
            pub fn default_value(this: &IEditorOption) -> V;

            #[wasm_bindgen(method, js_class = "IEditorOption", js_name = "defaultValue", setter)]
            pub fn set_default_value(this: &IEditorOption, default_value: V);
        ...
        extern "C" {
            ...
            /// Controls whether the cursor should move to find matches while
            /// typing.
            #[wasm_bindgen(
                method,
            ...
            /// Controls whether the search result and diff result automatically
            /// restarts from the beginning (or the end) when no further matches
            /// can be found
        ...
        extern "C" {
            ...
            /// The number of columns (of typical characters) fitting on a
            /// viewport line.
            #[wasm_bindgen(
                method,
                js_class = "EditorLayoutInfo",
        ...
        extern "C" {
            ...
            /// Limit the width of the minimap to render at most a certain
            /// number of columns. Defaults to 120.
            #[wasm_bindgen(
                method,
                js_class = "IEditorMinimapOptions",
                js_name = "maxColumn",
        ...
        extern "C" {
            ...
            /// Always consume mouse wheel events (always call preventDefault()
            /// and stopPropagation() on the browser events).
            /// Defaults to true.
            /// **NOTE**: This option cannot be updated using `updateOptions()`
            #[wasm_bindgen(
                method,
        ...
        extern "C" {
            ...
            /// Only characters between U+0020 and U+007E, tab, line-feed and
            /// carriage-return are considered basic ASCII.
            #[wasm_bindgen(
                method,
            ...
            /// Controls whether characters that just reserve space or have no
            /// width at all are highlighted.
            #[wasm_bindgen(
                method,
                js_class = "IUnicodeHighlightOptions",
            ...
            /// Controls whether characters are highlighted that can be confused
            /// with basic ASCII characters, except those that are common in the
            /// current user locale.
            #[wasm_bindgen(
                method,
                js_class = "IUnicodeHighlightOptions",
            ...
            /// Controls whether characters in comments should also be subject
            /// to unicode highlighting.
            #[wasm_bindgen(
                method,
                js_class = "IUnicodeHighlightOptions",
            ...
            /// Controls whether characters in strings should also be subject to
            ...
            /// Unicode characters that are common in allowed locales are not
            /// being highlighted.
            #[wasm_bindgen(
                method,
                js_class = "IUnicodeHighlightOptions",
        ...
        extern "C" {
            ...
            /// Configures the mode.
            /// Use `prefix` to only show ghost text if the text to replace is a
            /// prefix of the suggestion text. Use `subword` to only
            /// show ghost text if the replace text is a subword of the
            /// suggestion text. Use `subwordSmart` to only show
            /// ghost text if the replace text is a subword of the suggestion
            ...
            /// Does not clear active inline suggestions when the editor loses
            /// focus.
            #[wasm_bindgen(
                method,
                js_class = "IInlineSuggestOptions",
        ...
        extern "C" {
            ...
            /// Select suggestions when triggered via quick suggest or trigger
            /// characters
            #[wasm_bindgen(
                method,
                js_class = "ISuggestOptions",
        ...
        extern "C" {
            ...
            /// If the `afterColumn` has multiple view columns, the affinity
            /// specifies which one to use. Defaults to `none`.
            #[wasm_bindgen(
                method,
                js_class = "IViewZone",
            ...
            /// Tiebreaker that is used when multiple view zones want to be
            /// after the same line. Defaults to `afterColumn`
            /// otherwise 10000;
            ...
            /// If set, the editor will attach a mouse down listener to the view
            /// zone and .preventDefault on it. Defaults to false
            ...
            /// If neither `heightInPx` nor `heightInLines` is specified, a
            /// default of `heightInLines` = 1 will be chosen.
            ...
            /// If this is set, the editor will give preference to it rather
            /// than `heightInLines` above. If neither `heightInPx`
            /// nor `heightInLines` is specified, a default of `heightInLines` =
            /// 1 will be chosen.
            ...
            /// If this is set, the editor will ensure that the scroll width is
            /// >= than this value.
            ...
            /// An optional dom node for the view zone that will be placed in
            /// the margin area.
            ...
            /// Callback which gives the relative top of the view zone as it
            /// appears (taking scrolling into account).
        ...
        extern "C" {
            ...
            /// Remove a zone
            /// @param id A unique identifier to the view zone, as returned by
            /// the `addZone` call.
        ...
        extern "C" {
            ...
            /// Desired position which serves as an anchor for placing the
            /// content widget. The widget will be placed above, at,
            /// or below the specified position, based on the
            /// provided preference. The widget will always touch this position.
            ///
            /// Given sufficient horizontal space, the widget will be placed to
            /// the right of the passed in position. This can be
            /// tweaked by providing a `secondaryPosition`.
            ///
            /// @see preference
            ...
            /// define the placing of the content widget. The
            /// secondary position must have the same line number as the
            /// primary position. If possible, the widget will be placed such
            /// that it also touches the secondary position.
            #[wasm_bindgen(
                method,
                js_class = "IContentWidgetPosition",
            ...
            /// Placement preference when multiple view positions refer to the
            /// same (model) position. This plays a role when
            /// injected text is involved.
            #[wasm_bindgen(
                method,
                js_class = "IContentWidgetPosition",
        ...
        extern "C" {
            ...
            /// Render this content widget in a location where it could overflow
            /// the editor's view dom node.
            #[wasm_bindgen(
                method,
            ...
            /// Call preventDefault() on mousedown events that target the
            /// content widget.
            #[wasm_bindgen(
                method,
                js_class = "IContentWidget",
            ...
            /// If null is returned, the content widget will be placed off
            /// screen.
        ...
        extern "C" {
            ...
            /// If null is returned, the overlay widget is responsible to place
            /// itself.
        ...
        extern "C" {
            ...
            /// The priority order of the widget, used for determining which
            /// widget to render when there are multiple.
            #[wasm_bindgen(
                method,
                js_class = "IGlyphMarginWidgetPosition",
                js_name = "zIndex",
        ...
        extern "C" {
            ...
            /// Desired mouse column (e.g. when position.column gets clamped to
            /// text length -- clicking after text on a line).
        ...
        extern "C" {
            ...
            pub fn r#type(this: &IMouseTargetUnknown) -> MouseTargetType::UNKNOWN;
        ...
        extern "C" {
            ...
            pub fn r#type(this: &IMouseTargetTextarea) -> MouseTargetType::TEXTAREA;
            #[wasm_bindgen(
                method,
        ...
        extern "C" {
            ...
            pub fn r#type(this: &IMouseTargetContentText) -> MouseTargetType::CONTENT_TEXT;
            #[wasm_bindgen(
                method,
        ...
        extern "C" {
            ...
            pub fn r#type(this: &IMouseTargetContentEmpty) -> MouseTargetType::CONTENT_EMPTY;
            #[wasm_bindgen(
                method,
                js_class = "IMouseTargetContentEmpty",
                js_name = "position",
        ...
        extern "C" {
            ...
            pub fn r#type(this: &IMouseTargetContentWidget) -> MouseTargetType::CONTENT_WIDGET;
            #[wasm_bindgen(
                method,
                js_class = "IMouseTargetContentWidget",
                js_name = "position",
        ...
        extern "C" {
            ...
            pub fn r#type(this: &IMouseTargetOverlayWidget) -> MouseTargetType::OVERLAY_WIDGET;
            #[wasm_bindgen(
                method,
                js_class = "IMouseTargetOverlayWidget",
                js_name = "position",
        ...
        extern "C" {
            ...
            pub fn r#type(this: &IMouseTargetScrollbar) -> MouseTargetType::SCROLLBAR;
            #[wasm_bindgen(
                method,
        ...
        extern "C" {
            ...
            pub fn r#type(this: &IMouseTargetOverviewRuler) -> MouseTargetType::OVERVIEW_RULER;
        ...
        extern "C" {
            ...
            pub fn r#type(this: &IMouseTargetOutsideEditor) -> MouseTargetType::OUTSIDE_EDITOR;
            #[wasm_bindgen(
                method,
                js_class = "IMouseTargetOutsideEditor",
        ...
        extern "C" {
            ...
            /// An event emitted when the content of the current model has
            /// changed. @event
            #[wasm_bindgen(
                method,
            ...
            /// An event emitted when the language of the current model has
            /// changed. @event
            #[wasm_bindgen(
                method,
                js_class = "ICodeEditor",
            ...
            /// An event emitted when the language configuration of the current
            ...
            /// An event emitted when the options of the current model has
            /// changed. @event
            #[wasm_bindgen(
                method,
                js_class = "ICodeEditor",
            ...
            /// An event emitted when the configuration of the editor has
            /// changed. (e.g. `editor.updateOptions()`) @event
            #[wasm_bindgen(
                method,
                js_class = "ICodeEditor",
            ...
            /// An event emitted when the decorations of the current model have
            /// changed. @event
            #[wasm_bindgen(
                method,
                js_class = "ICodeEditor",
            ...
            /// An event emitted when the text inside this editor gained focus
            /// (i.e. cursor starts blinking). @event
            #[wasm_bindgen(
                method,
                js_class = "ICodeEditor",
            ...
            /// (i.e. cursor stops blinking). @event
            #[wasm_bindgen(
                method,
                js_class = "ICodeEditor",
            ...
            /// An event emitted when the text inside this editor or an editor
            ...
            /// An event emitted when editing failed because the editor is
            /// read-only. @event
            #[wasm_bindgen(
                method,
                js_class = "ICodeEditor",
            ...
            /// An event emitted when the content width or content height in the
            /// editor has changed. @event
            #[wasm_bindgen(
                method,
                js_class = "ICodeEditor",
            ...
            /// An event emitted when hidden areas change in the editor (e.g.
            /// due to folding). @event
            #[wasm_bindgen(
                method,
                js_class = "ICodeEditor",
            ...
            /// Returns true if the text inside this editor or an editor widget
            /// has focus.
            ...
            pub fn get_option(this: &ICodeEditor, id: T) -> FindComputedEditorOptionValueById;

            /// Returns the editor's configuration (without any validation or
            /// defaults).
            ...
            /// Check if the editor is currently scrolling towards a different
            /// scroll position.
            #[wasm_bindgen(
                method,
                js_class = "ICodeEditor",
            ...
            /// The edits will land on the undo-redo stack, but no "undo stop"
            /// will be pushed. @param source The source of the
            /// call. @param command The command to execute
            ...
            /// The edits will land on the undo-redo stack, but no "undo stop"
            /// will be pushed. @param source The source of the
            /// call. @param edits The edits to execute.
            ...
            pub fn execute_edits(
                ...
                source: JsValue,
                edits: js_sys::Array,
                end_cursor_state: Option<JsValue>,
            ) -> bool;
            ...
            /// Get all the decorations on a line (filtering out decorations
            /// from other editors).
            ...
            /// Get all the decorations for a range (filtering out decorations
            /// from other editors).
            ...
            /// All decorations added through this call will get the ownerId of
            /// this editor. @deprecated Use
            ...
            /// Get the vertical position (top offset) for the line's top w.r.t.
            /// to the first line.
            ...
            /// Get the vertical position (top offset) for the line's bottom
            /// w.r.t. to the first line.
            ...
            /// Get the vertical position (top offset) for the position w.r.t.
            /// to the first line.
            ...
            /// Add a content widget. Widgets must have unique ids, otherwise
            ...
            /// Layout/Reposition a content widget. This is a ping to the editor
            /// to call widget.getPosition() and update
            /// appropriately.
            ...
            /// Add an overlay widget. Widgets must have unique ids, otherwise
            /// they will be overwritten.
            ...
            /// Layout/Reposition an overlay widget. This is a ping to the
            /// editor to call widget.getPosition() and update
            /// appropriately.
            ...
            /// Add a glyph margin widget. Widgets must have unique ids,
            ...
            /// Layout/Reposition a glyph margin widget. This is a ping to the
            /// editor to call widget.getPosition() and update
            /// appropriately.
            ...
            /// Change the view zones. View zones are lost when a new model is
            ...
            /// Get the horizontal position (left offset) for the column w.r.t
            /// to the beginning of the line. This method works only
            /// if the line `lineNumber` is currently rendered (in the editor's
            /// viewport). Use this method with caution.
            ...
            ///
            /// @returns Hit test target or null if the coordinates fall outside
            /// the editor or the editor has no model.
            ...
            /// The result position takes scrolling into account and is relative
            /// to the top left corner of the editor. Explanation 1:
            /// the results of this method will change for the same `position`
            /// if the user scrolls the editor. Explanation 2: the
            /// results of this method will not change if the container of the
            /// editor gets repositioned. Warning: the results of
            /// this method are inaccurate for positions that are outside the
            ...
            /// Is called when the model has been set, view state was restored
            /// and options are updated. This is the best place to
            /// compute data for the viewport (such as tokens).
        ...
        extern "C" {
            ...
            /// An event emitted when the diff information computed by this diff
            /// editor has been updated. @event
            #[wasm_bindgen(method, js_class = "IDiffEditor", js_name = "onDidUpdateDiff", getter)]
            pub fn on_did_update_diff(this: &IDiffEditor) -> IEvent;
            /// An event emitted when the diff model is changed (i.e. the diff
            /// editor shows new content). @event
    ...
    pub mod languages {
        ...
        extern "C" {
            ...
            /// A file glob pattern like `*.{ts,js}` that will be matched on
            /// file paths relative to the base path.
            ///
            /// Example: Given a base of `/home/work/folder` and a file path of
            /// `/home/work/folder/index.js`, the file glob pattern
            /// will match on `index.js`.
        ...
        extern "C" {
            ...
            /// A pointer will be held to this and the object should not be
            /// modified by the tokenizer after the pointer is returned.
        ...
        extern "C" {
            ...
            /// The tokens on the line in a binary, encoded format. Each token
            /// occupies two array indices. For token i:
            ///  - at offset 2*i => startIndex
            ///  - at offset 2*i + 1 => metadata
            /// Meta data is in binary format:
            /// - ------------------------------------------- 3322 2222 2222
            ///   1111 1111 1100 0000 0000 1098 7654 3210 9876 5432 1098 7654
            ///   3210
            /// - ------------------------------------------- bbbb bbbb bfff
            ///   ffff ffFF FFTT LLLL LLLL
            /// - -------------------------------------------
            ///  - L = EncodedLanguageId (8 bits): Use `getEncodedLanguageId` to
            ///    get the encoded ID of a language.
            ///  - T = StandardTokenType (2 bits): Other = 0, Comment = 1,
            ///    String = 2, RegEx = 3.
            ///  - F = FontStyle (4 bits): None = 0, Italic = 1, Bold = 2,
            ...
            /// e.g. colorId = 1 is stored in
            /// IStandaloneThemeData.customTokenColors[1]. Color id = 0 means no
            /// color, id = 1 is for the default foreground color,
            /// id = 2 for the default background.
        ...
        extern "C" {
            ...
            /// The initial state of a language. Will be the state passed in to
        ...
        extern "C" {
            ...
            /// Given a code action fill in the edit. Will only invoked when
            /// missing.
        ...
        extern "C" {
            ...
            /// List of code action kinds that a {@link CodeActionProvider} may
            /// return.
            ///
            /// This list is used to determine if a given `CodeActionProvider`
            /// should be invoked or not. To avoid unnecessary
            /// computation, every `CodeActionProvider` should list use
            /// `providedCodeActionKinds`. The list of kinds may
            /// either be generic, such as `["quickfix", "refactor", "source"]`,
            /// or list out every kind provided, such as `["
            /// quickfix.removeLine", "source.fixAll" ...]`.
            #[wasm_bindgen(
                method,
        ...
        extern "C" {
            ...
            /// This configuration implicitly affects pressing Enter around
            /// these brackets.
            #[wasm_bindgen(
                method,
                js_class = "LanguageConfiguration",
            ...
            /// If the language supports Unicode identifiers (e.g. JavaScript),
            /// it is preferable to provide a word definition that
            /// uses exclusion of known separators. e.g.: A regex
            /// that matches anything except known separators (and dot is
            ...
            /// automatically inserted with the 'open' character is
            /// typed. If not set, the configured brackets will be used.
            #[wasm_bindgen(
                method,
                js_class = "LanguageConfiguration",
            ...
            /// The language's surrounding pairs. When the 'open' character is
            /// typed on a selection, the selected string is
            /// surrounded by the open and close characters. If not set, the
            ...
            /// Defines a list of bracket pairs that are colorized depending on
            /// their nesting level. If not set, the configured
            ...
            /// Defines what characters must be after the cursor for bracket or
            /// quote autoclosing to occur when using the \'languageDefined\'
            /// autoclosing setting.
            ///
            /// This is typically the set of characters which can not start an
            /// expression, such as whitespace, closing brackets, non-unary
            /// operators, etc.
            #[wasm_bindgen(
                method,
                js_class = "LanguageConfiguration",
        ...
        extern "C" {
            ...
            /// If a line matches this pattern, then **only the next line**
        ...
        extern "C" {
            ...
            /// Used by the indentation based strategy to decide whether empty
            /// lines belong to the previous or the next block.
            /// A language adheres to the off-side rule if blocks in that
            /// language are expressed by their indentation. See [wikipedia](https://en.wikipedia.org/wiki/Off-side_rule) for more information.
            /// If not set, `false` is used and empty lines belong to the
            /// previous block.
        ...
        extern "C" {
            ...
            /// This rule will only execute if the text above the this line
            /// matches this regular expression.
        ...
        extern "C" {
            ...
            /// The string that appears on the last line and closes the doc
            /// comment (e.g. ' * /').
        ...
        extern "C" {
            ...
            /// hovers at the same position will be merged by the
            /// editor. A hover can have a range which defaults
        ...
        extern "C" {
            ...
            /// with other items. When `falsy` the {@link CompletionItem.label
            /// label} is used.
            ...
            /// completion items. When `falsy` the {@link CompletionItem.label
            /// label} is used.
            ...
            /// item can be selected and that the editor decides
            /// which item that is. The rule is that the *first* item of those
            ...
            /// Additional rules (as bitmask) that should be applied when
            ...
            /// current position.
            ///
            /// *Note:* The range must be a {@link Range.isSingleLine single
            /// line} and it must {@link Range.contains contain} the
            /// position at which completion has been {@link
            /// CompletionItemProvider.provideCompletionItems requested}.
            ...
            /// completion is active will accept it first and
            /// then type that character. *Note* that all commit characters
            /// should have `length=1` and that superfluous
        ...
        extern "C" {
            ...
            /// CompletionItem.documentation doc-comment}
        ...
        extern "C" {
            ...
            /// The text to insert.
            /// If the text contains a line break, the range must end at the end
            /// of a line. If existing text should be replaced, the
            /// existing text must be a prefix of the text to insert.
            ///
            /// The text can also be a snippet. In that case, a preview with
            /// default parameters is shown. When accepting the
            /// suggestion, the full snippet is inserted.
            #[wasm_bindgen(method, js_class = "InlineCompletion", js_name = "insertText", getter)]
            pub fn insert_text(this: &InlineCompletion) -> JsValue;
            /// A text that is used to decide if this inline completion should
            /// be shown. An inline completion is shown if the text
            /// to replace is a subword of the filter text.
            ...
            /// If set to `true`, unopened closing brackets are removed and
            /// unclosed opening brackets are closed. Defaults to
            /// `false`.
            #[wasm_bindgen(
                method,
                js_class = "InlineCompletion",
        ...
        extern "C" {
            ...
            /// A list of commands associated with the inline completions of
            /// this list.
            ...
            /// When set and the user types a suggestion without derivating from
            /// it, the inline suggestion is not updated.
            #[wasm_bindgen(
                method,
                js_class = "InlineCompletions",
        ...
        extern "C" {
            ...
            /// @param updatedInsertText Is useful to understand bracket
            /// completion.
            #[wasm_bindgen(
                method,
                js_class = "InlineCompletionsProvider",
            ...
            /// Will be called when a completions list is no longer in use and
            ...
            pub fn free_inline_completions(this: &InlineCompletionsProvider, completions: T);
            ...
            /// The current provider is only requested for completions if no
            /// provider with a preferred group id returned a result.
            #[wasm_bindgen(
                method,
                js_class = "InlineCompletionsProvider",
        ...
        extern "C" {
            ...
            /// A list of ranges that can be edited together. The ranges must
            /// have identical length and text content. The ranges
            /// cannot overlap
            ...
            /// An optional word pattern that describes valid contents for the
            /// given ranges. If no pattern is provided, the
            /// language configuration's word pattern will be used.
            #[wasm_bindgen(
                method,
        ...
        extern "C" {
            ...
            /// Provide the implementation of the symbol at the given position
            /// and document.
            #[wasm_bindgen(
                method,
        ...
        extern "C" {
            ...
            /// Provide the type definition of the symbol at the given position
            /// and document.
            #[wasm_bindgen(
                method,
        ...
        extern "C" {
            ...
            /// The list of multiple ranges to format at once, if the provider
            /// supports it.
        ...
        extern "C" {
            ...
            /// smaller or larger range. Often this is done by
            /// adjusting the start and end of the range to full
            /// syntax nodes.
            #[wasm_bindgen(
                method,
                js_class = "DocumentRangeFormattingEditProvider",
        ...
        extern "C" {
            ...
            /// color picker header. By default this is also the
            /// text that is inserted when selecting this color
            /// presentation.
            ...
            /// selecting this presentation for the color.
            ...
            /// An optional array of additional {@link TextEdit text edits} that
            /// are applied when selecting this color presentation.
            #[wasm_bindgen(
                method,
        ...
        extern "C" {
            ...
            /// An optional event to signal that the folding ranges from this
        ...
        extern "C" {
            ...
            /// The one-based start line of the range to fold. The folded area
            ...
            /// The one-based end line of the range to fold. The folded area
            /// ends with the line's last character.
            ...
            /// Describes the {@link FoldingRangeKind Kind} of the folding range
            /// such as {@link FoldingRangeKind.Comment Comment} or
            /// {@link FoldingRangeKind.Region Region}. The kind is used to
            /// categorize folding ranges and used by commands
            /// like 'Fold all comments'. See
            /// {@link FoldingRangeKind} for an enumeration of standardized
            /// kinds.
        ...
        extern "C" {
            ...
            /// if no match in the tokenizer assign this token class (default
            /// 'source')
            #[wasm_bindgen(
                method,
            ...
            /// start symbol in the tokenizer (by default the first entry is
            /// used)
        ...
        extern "C" {
            ...
            /// switch to embedded language (using the mimetype) or get out
            /// using "@pop"
            #[wasm_bindgen(
                method,
                js_class = "IExpandedMonarchLanguageAction",
        ...
        pub mod css {
            ...
            extern "C" {
                ...
                /// put braces on the same line as rules (`collapse`), or put
                /// braces on own line, Allman / ANSI style (`expand`). Default
                /// `collapse`
                #[wasm_bindgen(
                    method,
                    js_class = "CSSFormatConfiguration",
                ...
                /// whether existing line breaks before elements should be
            ...
            extern "C" {
                ...
                /// Defines whether the built-in completionItemProvider is
                /// enabled.
                #[wasm_bindgen(
                    method,
                ...
                /// Defines whether the built-in documentSymbolProvider is
                /// enabled.
                #[wasm_bindgen(
                    method,
                    js_class = "ModeConfiguration",
                ...
                /// Defines whether the built-in definitions provider is
                /// enabled.
                #[wasm_bindgen(
                    method,
                    js_class = "ModeConfiguration",
                ...
                /// Defines whether the built-in foldingRange provider is
                /// enabled.
                #[wasm_bindgen(
                    method,
                    js_class = "ModeConfiguration",
                ...
                /// Defines whether the built-in selection range provider is
                /// enabled.
                #[wasm_bindgen(
                    method,
                    js_class = "ModeConfiguration",
                ...
                /// Defines whether the built-in document formatting edit
                /// provider is enabled.
                #[wasm_bindgen(
                    method,
                    js_class = "ModeConfiguration",
                ...
                /// Defines whether the built-in document formatting range edit
                /// provider is enabled.
                #[wasm_bindgen(
                    method,
                    js_class = "ModeConfiguration",
            ...
            extern "C" {
                ...
                /// Defines whether the standard CSS properties, at-directives,
                /// pseudoClasses and pseudoElements are shown.
                #[wasm_bindgen(
                    method,
        ...
        pub mod html {
            ...
            extern "C" {
                ...
                /// Configures the HTML data types known by the HTML langauge
                /// service.
                #[wasm_bindgen(method, js_class = "Options", js_name = "data", getter)]
            ...
            extern "C" {
                ...
                pub fn selection_ranges(this: &ModeConfiguration) -> bool;
                /// Defines whether the built-in documentFormattingEdit provider
                /// is enabled.
                #[wasm_bindgen(
                    method,
                    js_class = "ModeConfiguration",
                ...
                pub fn document_formatting_edits(this: &ModeConfiguration) -> bool;
                /// Defines whether the built-in documentRangeFormattingEdit
                /// provider is enabled.
                #[wasm_bindgen(
                    method,
                    js_class = "ModeConfiguration",
            ...
            extern "C" {
                ...
                /// Defines whether the standard HTML tags and attributes are
                /// shown
                #[wasm_bindgen(
                    method,
        ...
        pub mod json {
            ...
            extern "C" {
                ...
                /// If set, the validator will be enabled and perform syntax and
                /// schema based validation,
                /// unless `DiagnosticsOptions.schemaValidation` is set to
                /// `ignore`.
                #[wasm_bindgen(
                    method,
                ...
                /// If set, comments are tolerated. If set to false, syntax
                /// errors will be emitted for comments.
                /// `DiagnosticsOptions.allowComments` will override this
                /// setting.
                #[wasm_bindgen(
                    method,
                    js_class = "DiagnosticsOptions",
                ...
                /// A list of known schemas and/or associations of schemas to
                /// file names.
                #[wasm_bindgen(
                    method,
                    js_class = "DiagnosticsOptions",
                ...
                ///  If set, the schema service would load schema content
                /// on-demand with 'fetch' if available
                #[wasm_bindgen(
                    method,
                    js_class = "DiagnosticsOptions",
                ...
                /// The severity of problems from schema validation. If set to
                /// 'ignore', schema validation will be skipped. If not set,
                /// 'warning' is used.
                #[wasm_bindgen(
                    method,
                    js_class = "DiagnosticsOptions",
                ...
                /// The severity of problems that occurred when resolving and
                /// loading schemas. If set to 'ignore', schema resolving
                /// problems are not reported. If not set, 'warning' is used.
                #[wasm_bindgen(
                    method,
                    js_class = "DiagnosticsOptions",
                ...
                /// The severity of reported trailing commas. If not set,
                /// trailing commas will be reported as errors.
                #[wasm_bindgen(
                    method,
                    js_class = "DiagnosticsOptions",
                ...
                /// The severity of reported comments. If not set,
                /// 'DiagnosticsOptions.allowComments' defines whether comments
                /// are ignored or reported as errors.
                #[wasm_bindgen(
                    method,
                    js_class = "DiagnosticsOptions",
                    js_name = "comments",
        ...
        pub mod typescript {
            ...
            /// A linked list of formatted diagnostic messages to be used as
            /// part of a multiline message. It is built from the
            /// bottom up, leaving the head to be the "main" diagnostic.
            ...
            extern "C" {
                ...
                /// Diagnostic category: warning = 0, error = 1, suggestion = 2,
                /// message = 3
                #[wasm_bindgen(
                    method,
                    js_class = "DiagnosticMessageChain",
            ...
            extern "C" {
                ...
                /// `true` to indicate when a diagnostic is an unused-identifier
                /// diagnostic.
                #[wasm_bindgen(
                    method,
                    js_class = "Diagnostic",
            ...
            extern "C" {
                ...
                /// TypeScriptWorker removes all but the `fileName` property to
                /// avoid serializing circular JSON structures.
                #[wasm_bindgen(
                    method,
                    js_class = "DiagnosticRelatedInformation",
                    js_name = "file",
            ...
            extern "C" {
                ...
                pub fn document_range_formatting_edits(this: &ModeConfiguration) -> bool;
                /// Defines whether the built-in signature help provider is
                /// enabled.
                #[wasm_bindgen(
                    method,
                    js_class = "ModeConfiguration",
                ...
                /// Defines whether the built-in onType formatting edit provider
                /// is enabled.
                #[wasm_bindgen(
                    method,
                    js_class = "ModeConfiguration",
                ...
                /// Defines whether the built-in code actions provider is
                /// enabled.
                #[wasm_bindgen(
                    method,
                    js_class = "ModeConfiguration",
                ...
                /// Defines whether the built-in inlay hints provider is
                /// enabled.
                #[wasm_bindgen(
                    method,
                    js_class = "ModeConfiguration",
            ...
            extern "C" {
                ...
                /// Event fired when compiler options or diagnostics options are
                /// changed.
                #[wasm_bindgen(
                    method,
                    js_class = "LanguageServiceDefaults",
                ...
                pub fn on_did_change(this: &LanguageServiceDefaults) -> IEvent;
                /// Event fired when extra libraries registered with the
                ...
                /// Get the current extra libs registered with the language
                /// service.
                #[wasm_bindgen(
                    method,
                    js_class = "LanguageServiceDefaults",
                ...
                /// Add an additional source file to the language service. Use
                /// this for typescript (definition) files that
                /// won't be loaded as editor documents, like
                /// `jquery.d.ts`.
                ///
                ...
                /// files to the language service. Use this for typescript
                /// definition files that won't be loaded as
                /// editor documents, like `jquery.d.ts`. @param
                /// libs An array of entries to register.
                #[wasm_bindgen(
                    method,
                    js_class = "LanguageServiceDefaults",
                ...
                /// Get current TypeScript compiler options for the language
                /// service.
                #[wasm_bindgen(
                    method,
                    js_class = "LanguageServiceDefaults",
                ...
                /// Get the current diagnostics options for the language
                /// service.
                #[wasm_bindgen(
                    method,
                    js_class = "LanguageServiceDefaults",
                ...
                /// Configure whether syntactic and/or semantic validation
                /// should be performed
                #[wasm_bindgen(
                    method,
                    js_class = "LanguageServiceDefaults",
                ...
                /// Get the current setting for whether all existing models
                /// should be eagerly sync'd to the worker on
                /// start or restart.
                #[wasm_bindgen(
                    method,
                    js_class = "LanguageServiceDefaults",
            ...
            extern "C" {
                ...
                /// Get diagnostic messages for any syntax issues in the given
                /// file.
                #[wasm_bindgen(
                    method,
                ...
                /// Get diagnostic messages for any semantic issues in the given
                /// file.
                #[wasm_bindgen(
                    method,
                    js_class = "TypeScriptWorker",
                ...
                /// Get diagnostic messages for any suggestions related to the
                /// given file.
                #[wasm_bindgen(
                    method,
                    js_class = "TypeScriptWorker",
                ...
                /// Get diagnostic messages related to the current compiler
                /// options. @param fileName Not used
                #[wasm_bindgen(
                    method,
                    js_class = "TypeScriptWorker",
                ...
                /// Get code completion details for the given file, position,
                /// and entry. @returns `Promise<typescript.
                ...
                /// Get signature help items for the item at the given file and
                /// position. @returns `Promise<typescript.
                ...
                /// Get quick info for the item at the given position in the
                /// file. @returns `Promise<typescript.QuickInfo
                /// | undefined>`
                #[wasm_bindgen(
                    method,
                    js_class = "TypeScriptWorker",
                ...
                /// Get the definition of the item at the given position in the
                /// file.
                /// @returns `Promise<ReadonlyArray<typescript.DefinitionInfo> |
                /// undefined>`
                #[wasm_bindgen(
                    method,
                    js_class = "TypeScriptWorker",
                ...
                /// Get references to the item at the given position in the
                /// file. @returns `Promise<typescript.
                ...
                /// Get outline entries for the item at the given position in
                /// the file. @returns `Promise<typescript.
                ...
                /// Get changes which should be applied to format the given
                /// file. @param options
                ...
                /// Get changes which should be applied to format the given
                /// range in the file. @param options
                /// `typescript.FormatCodeOptions`
                /// @returns `Promise<typescript.TextChange[]>`
                #[wasm_bindgen(
                    method,
                ...
                /// Get formatting changes which should be applied after the
                /// given keystroke. @param options
                /// `typescript.FormatCodeOptions`
                /// @returns `Promise<typescript.TextChange[]>`
                #[wasm_bindgen(
                    method,
                ...
                /// Get other occurrences which should be updated when renaming
                /// the item at the given file and position.
                /// @returns `Promise<readonly typescript.RenameLocation[] |
                /// undefined>`
                #[wasm_bindgen(
                    method,
                    js_class = "TypeScriptWorker",
                ...
                /// Get edits which should be applied to rename the item at the
                /// given file and position (or a failure reason).
    ...
    pub mod worker {
        ...
        extern "C" {
            ...
            pub fn host(this: &IWorkerContext) -> H;

            #[wasm_bindgen(method, js_class = "IWorkerContext", js_name = "host", setter)]
            pub fn set_host(this: &IWorkerContext, host: H);
